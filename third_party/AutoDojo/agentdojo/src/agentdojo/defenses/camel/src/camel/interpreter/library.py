...
"""Standard library implementation adapted from Starlark behavior."""
...
"""Built-in functions supported in Starlark, plus small local extensions."""
...
"""Built-in methods supported in Starlark, plus small local extensions."""
