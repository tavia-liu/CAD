#!/usr/bin/env python3
"""Replay adaptive AutoDojo attacks on AgentDyn suites for one Full-CAD head family."""
...
def main() -> None:
    ...
    run_root = args.run_root or ROOT / "runs/adaptive_autodojo_agentdyn" / args.family
    result_root = args.result_root or ROOT / "results/adaptive_autodojo_agentdyn" / args.family
    ...
    # adaptive attacks; CU/UA/ASR on AgentDyn suites).
    ...
    for alpha in sorted(set(args.alphas)):
        ...
        row = {
            "benchmark": "adaptive_autodojo_agentdyn", "family": args.family,
