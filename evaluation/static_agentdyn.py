#!/usr/bin/env python3
"""Run static AgentDyn attacks against one adversarially trained Full-CAD head."""
...
def main() -> None:
    ...
    run_root = args.run_root or ROOT / "runs/static_agentdyn" / args.family
    result_root = args.result_root or ROOT / "results/static_agentdyn" / args.family
    ...
    for alpha in sorted(set(args.alphas)):
        ...
        # CU/UA/ASR as defined in the paper's Experiments section, here for the
        # static attacks on the AgentDyn suites (github/shopping/dailylife).
        row = {
            "benchmark": "static_agentdyn", "family": args.family,
